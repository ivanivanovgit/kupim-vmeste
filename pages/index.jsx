  ...
  return (
    <div className={stylesHome.container}>
      ...
      <ol className={stylesHome.numberedList}>
        <li>
          1. Вы стали собственником квартиры в новом комплексе или дачи в
          садовом товариществе. Вы можете закинуть ссылку на этот сервис в общий
          чат, и найти соседей, легче спланировав с помощью данного сервиса
          совместную покупку строительных материалов, экономя на доставке
          крупногабаритных товаров.
        </li>
        <li>
          2. После ремонта у вас остались стройматериалы, которые вы хотите
          продать. Оставьте объявление на вкладке "Чат на карте"
        </li>
        <li>
          3. Вы регулярно следуете определённому маршруту на работу или
